...
public class DialogPickDurationPre2Alerte extends DialogFragment implements NumberPicker.OnValueChangeListener {
    NumberPicker numberPicker_pre_alerte_m,numberPicker_pre_alerte_s;
    Duration duration;


    DialogPickDurationPre2Alerte.DialogPickDurationPre2AlerteListener pickDurationPre2AlerteListener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        duration = new Duration(preferences.getInt(getContext().getResources().getString(R.string.key_pre2_alerte_m),-1),
                preferences.getInt(getContext().getResources().getString(R.string.key_pre2_alerte_s),-1));

        numberPicker_pre_alerte_m = view.findViewById(R.id.numberPicker_pre_alerte_m);
        numberPicker_pre_alerte_m.setMaxValue(5);
        ...
        }else if(numberPicker_pre_alerte_m.getValue() == 5){
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                editor.putInt(getContext().getResources().getString(R.string.key_pre2_alerte_s),duration.getSecond());
                editor.putInt(getContext().getResources().getString(R.string.key_pre2_alerte_m),duration.getMinute());
                editor.commit();
                pickDurationPre2AlerteListener.applyText_pre2_alarme(duration);
    ...
    public void onAttach(Context context) {
        ...
        try {
            pickDurationPre2AlerteListener = (DialogPickDurationPre2Alerte.DialogPickDurationPre2AlerteListener) context;
    ...
    public interface DialogPickDurationPre2AlerteListener{
        void applyText_pre2_alarme(Duration duration);
    }
}
